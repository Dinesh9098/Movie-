...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Zxcv:Zxcvbnm@cluster0.uqakxxn.mongodb.net/?retryWrites=true&w=majority")
...
URL = "https://ytra.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://ytra.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://ytra.onrender.com/".format(FQDN)
else:
    URL = "https://ytra.onrender.com/".format(FQDN)
